...
performance_metrics_oos_mod_2 = compute_metrics_prob_classifier(p_hats_test, y_test) %>% data.table
ggplot(performance_metrics_oos) +
  geom_line(aes(x = FPR, y = recall), col = "blue") +
  geom_abline(intercept = 0, slope = 1, col = "red") + 
  coord_fixed() + xlim(0, 1) + ylim(0, 1) +
  geom_line(data = performance_metrics_oos_mod_2, aes(x = FPR, y = recall), col = "green")
```
