---
title: "Practice Lecture 1 MATH 390.4 Queens College"
...
```{R}
3,125 #commas are illegal andnote that RStudio finds basic errors for us
...
There are lots of options. Look at the help file by using the question mark:
...
class(as.integer(1)) #what's the L doing? It's forcing a certain type
...
1 -> x #maybe because you can do this?? But don't do this!!
x
